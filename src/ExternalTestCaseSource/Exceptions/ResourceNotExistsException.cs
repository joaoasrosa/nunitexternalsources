...
namespace NUnitEx.ExternalTestCaseSource.Exceptions
{
    ...
    public class ResourceNotExistsException : Exception
    {
        ...
        /// NUnitEx.ExternalTestCaseSource.Exceptions.ResourceNotExistsException class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the 
        /// NUnitEx.ExternalTestCaseSource.Exceptions.ResourceNotExistsException class with a specified error
        /// message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="innerException">The exception that is the cause of the current exception, or a null reference
        ///     (Nothing in Visual Basic) if no inner exception is specified.</param>
        public ResourceNotExistsException(string message, Exception innerException)
